...
../mrsequential ../../mrapps/wc.so ../fixtures/pg*txt || exit 1
sort mr-out-0 > mr-correct-wc.txt
rm -f mr-out*

echo '***' Starting wc test.

maybe_quiet $TIMEOUT ../mrcoordinator ../fixtures/pg*txt &
pid=$!
...
# generate the correct output
../mrsequential ../../mrapps/indexer.so ../fixtures/pg*txt || exit 1
...
(maybe_quiet $TIMEOUT ../mrcoordinator ../fixtures/pg*txt; touch $DF) &
...
# generate the correct output
../mrsequential ../../mrapps/nocrash.so ../fixtures/pg*txt || exit 1
sort mr-out-0 > mr-correct-crash.txt
rm -f mr-out*

rm -f mr-done
((maybe_quiet $TIMEOUT2 ../mrcoordinator ../fixtures/pg*txt); touch mr-done ) &
sleep 1
